 ...
 */
const CACHE_NAME = 'goja-v10.2.12-2';
const ASSETS = [
  './',
  './index.html',
  './css/variables.css',
  ...
  './js/photo-loader.js',
  './js/export-flow.js',
  './js/export-page-lifecycle.js',
  './js/display-mode.js',
  './js/export-open-target.js',
  './js/export-pwa-preview.js',
  './js/preview-updater.js',
  './js/action-buttons.js',
  './js/app-init.js',
  './js/frame-validation.js',
  './js/bg-color-control.js',
