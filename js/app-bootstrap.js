...
export function bootstrap() {
  ...
  const [globalFrameShape, globalFrameStrokeEnabled, globalFrameStrokeWidth, globalFrameStrokeColor, globalFrameStrokeOpacity, outsideBackgroundColor, cellShapeTemplate, cellShapeOrientation] =
    ['#globalFrameShape', '#globalFrameStrokeEnabled', '#globalFrameStrokeWidth', '#globalFrameStrokeColor', '#globalFrameStrokeOpacity', '#outsideBackgroundColor', '#cellShapeTemplate', '#cellShapeOrientation'].map($);
