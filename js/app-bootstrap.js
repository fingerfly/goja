...
import { resolveEdgeSupport } from './edge-capability.js';
...
export function bootstrap() {
  ...
  const [wmType, wmText, wmTextGroup, wmPos, wmPosGroup, wmOpacity, wmOpacityGroup, wmFontSize, wmFontSizeGroup, wmColor, wmColorGroup, wmTileOptionsGroup, wmTileSpacing, wmTileRotation] =
    ['#watermarkType', '#watermarkText', '#watermarkTextGroup', '#watermarkPos', '#watermarkPosGroup', '#watermarkOpacity', '#watermarkOpacityGroup', '#watermarkFontSize', '#watermarkFontSizeGroup', '#watermarkColor', '#watermarkColorGroup', '#watermarkTileOptionsGroup', '#watermarkTileSpacing', '#watermarkTileRotation'].map($);
  ...
  const [globalFrameShape, globalFrameStrokeEnabled, globalFrameStrokeWidth, globalFrameStrokeColor, globalFrameStrokeOpacity, outsideBackgroundColor, cellShapeTemplate, cellShapeOrientation, superellipseExponent] =
    ['#globalFrameShape', '#globalFrameStrokeEnabled', '#globalFrameStrokeWidth', '#globalFrameStrokeColor', '#globalFrameStrokeOpacity', '#outsideBackgroundColor', '#cellShapeTemplate', '#cellShapeOrientation', '#superellipseExponent'].map($);
  ...
  const edgeSupport = resolveEdgeSupport();
  edgeOptionsGroup?.classList.toggle('hidden', !edgeSupport.advancedSupported);
  const formRefs = {
    wmType, wmText, wmPos, wmOpacity, wmFontSize, wmColor, wmTileSpacing, wmTileRotation, showCaptureDate, captureDatePos, captureDateOpacity, captureDateFontSize,
