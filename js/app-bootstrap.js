...
export function bootstrap() {
  ...
  const [wmType, wmText, wmTextGroup, wmPos, wmPosGroup, wmOpacity, wmOpacityGroup, wmFontSize, wmFontSizeGroup, wmColor, wmColorGroup, wmTileOptionsGroup, wmTileSpacing, wmTileColSpacing, wmTileRotation] =
    ['#watermarkType', '#watermarkText', '#watermarkTextGroup', '#watermarkPos', '#watermarkPosGroup', '#watermarkOpacity', '#watermarkOpacityGroup', '#watermarkFontSize', '#watermarkFontSizeGroup', '#watermarkColor', '#watermarkColorGroup', '#watermarkTileOptionsGroup', '#watermarkTileSpacing', '#watermarkTileColSpacing', '#watermarkTileRotation'].map($);
  ...
  const formRefs = {
    wmType, wmText, wmPos, wmOpacity, wmFontSize, wmColor, wmTileSpacing, wmTileColSpacing, wmTileRotation, showCaptureDate, captureDatePos, captureDateOpacity, captureDateFontSize,
