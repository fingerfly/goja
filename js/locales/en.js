export default {
  ...
  edgeIntensity: 'Edge amplitude',
  edgeIntensityHint: 'Fine tune with slider or number (0.00-1.00).',
  edgeFrequency: 'Edge cycles',
  edgeFrequencyHint: 'Integer cycles per edge (1-20).',
  edgeSeed: 'Edge seed',
  edgeSeedHint: 'Use an integer seed for repeatable edges.',
  watermark: 'Watermark',
  watermarkType: 'Type',
  watermarkNone: 'None',
