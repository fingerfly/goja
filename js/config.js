...
export const WATERMARK_TILE_SPACING_MIN = 0;
export const WATERMARK_TILE_SPACING_MAX = 400;
export const WATERMARK_TILE_SPACING_DEFAULT = 80;
export const WATERMARK_TILE_SPACING_STEP = 1;
export const WATERMARK_TILE_COL_SPACING_MIN = 0;
export const WATERMARK_TILE_COL_SPACING_MAX = 400;
export const WATERMARK_TILE_COL_SPACING_DEFAULT = 0;
export const WATERMARK_TILE_COL_SPACING_STEP = 1;
...
export const WATERMARK_TILE_ROTATION_STEP = 1;
